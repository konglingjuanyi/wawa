...
import com.yimidida.shards.session.impl.ShardedSqlSessionFactoryImpl;
...
public class ShardedConfiguration {
	...
	public ShardedConfiguration(List<ShardConfiguration> shardConfigs, ShardStrategyFactory shardStrategyFactory, IdGenerator idGenerator) {
